...
export interface IStorage {
  ...
  updateUser(id: number, data: Partial<Pick<User, "username" | "password" | "displayName" | "profileImage" | "bannerImage" | "bannerColor" | "accentColor" | "audienceMessage">>): Promise<User | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateUser(id: number, data: Partial<Pick<User, "username" | "password" | "displayName" | "profileImage" | "bannerImage" | "bannerColor" | "accentColor" | "audienceMessage">>): Promise<User | undefined> {
